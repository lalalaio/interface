...
var _recentPosts = __webpack_require__(69);

var _recentPosts2 = _interopRequireDefault(_recentPosts);
...
_reactDom2.default.render(_react2.default.createElement(
  'div',
  { className: 'body' },
  _react2.default.createElement(_recentPosts2.default, {
...
var _postList = __webpack_require__(122);
...
var RecentPosts = function (_React$Component) {
  (0, _inherits3.default)(RecentPosts, _React$Component);

  function RecentPosts(props) {
    (0, _classCallCheck3.default)(this, RecentPosts);

    var _this = (0, _possibleConstructorReturn3.default)(this, (RecentPosts.__proto__ || (0, _getPrototypeOf2.default)(RecentPosts)).call(this, props));
  ...
  (0, _createClass3.default)(RecentPosts, [{
    key: 'componentDidMount',
    value: function () {
      var _ref = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee() {
        var _this2 = this;

        var recentPostsApi, recentPostUuids, recentPosts;
        return _regenerator2.default.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                recentPostsApi = this.props.apiBase + '/post/latest';
                _context.next = 3;
                return fetch(recentPostsApi).then(function (response) {
              ...
              case 3:
                recentPostUuids = _context.sent;
                _context.next = 6;
                return _promise2.default.all(recentPostUuids.map(function (postUuid) {
                  var postApi = _this2.props.apiBase + '/post/' + postUuid;
                  return fetch(postApi).then(function (response) {
                    return response.json();
                  }).catch(function (error) {
...
var _post = __webpack_require__(126);
...
var PostList = function PostList(_ref) {
  ...
  var listItems = posts.map(function (post) {
    return React.createElement(
      'li',
      { key: post.uuid },
      React.createElement(_post2.default, { post: post })
    );
  });
  return React.createElement(
    'ul',
...
var Post = function Post(_ref) {
  ...
  var bars = post.notes.reduce(function (bars, note) {
    Array(noteBeats[note.duration]).fill('').map(function (_, index) {
      var barNote = { 'note': note.note };
      if (index === 0) {
        barNote.start = true;
      }
  ...
  bars = [].concat((0, _toConsumableArray3.default)(bars), (0, _toConsumableArray3.default)(Array(8).fill([]))).slice(0, 8);
  bars = bars.map(function (bar) {
    return [].concat((0, _toConsumableArray3.default)(bar), (0, _toConsumableArray3.default)(Array(16).fill({ 'note': 'REST' }))).slice(0, 16);
  });
  var barList = bars.map(function (notes, index) {
    return React.createElement(_bar2.default, { key: index, notes: notes, index: index });
  });
  return React.createElement(
    'div',
    { className: 'post', 'data-uuid': post.uuid },
    React.createElement(
      'div',
      { className: 'notes' },
      barList
...
var _note = __webpack_require__(133);
...
var Bar = function Bar(_ref) {
  ...
  var noteList = notes.map(function (tone, noteIndex) {
    return React.createElement(_note2.default, { key: noteIndex, tone: tone, index: noteIndex });
  });
  var className = 'bar bar-' + (index + 1);
  return React.createElement(
    'div',
    { className: className },
    noteList
...
Bar.propTypes = {
  notes: _propTypes2.default.arrayOf(_propTypes2.default.object),
...
var _tone = __webpack_require__(137);
...
var Note = function Note(_ref) {
  ...
  var toneList = (0, _keys2.default)(toneChart).map(function (toneIndex) {
    var active = tone.note === toneChart[toneIndex];
    return React.createElement(_tone2.default, {
      key: toneIndex,
      active: active,
  ...
  var className = 'note note-' + (index + 1);
  return React.createElement(
    'div',
    { className: className },
    toneList
...
Note.propTypes = {
  tone: _propTypes2.default.object,
  index: _propTypes2.default.number
};
...
var Tone = function Tone(_ref) {
  ...
  var startClass = start ? ' start' : '';
  var endClass = end ? ' end' : '';
  var maybeClasses = '' + activeClass + startClass + endClass;
  var className = 'tone tone-' + (index + 1) + maybeClasses;
  return React.createElement('div', { className: className });
};

Tone.propTypes = {
  active: _propTypes2.default.bool,
  start: _propTypes2.default.bool,
